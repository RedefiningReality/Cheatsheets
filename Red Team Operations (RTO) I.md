...
- in Settings → Core Plugins, enable Outline. Then run "Outline: Show Outline" in the command palette. Now you can quickly jump to a particular section by clicking its heading in the outline
